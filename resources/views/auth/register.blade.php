...
@section('title', 'Create Account — Alternative')
...
<div class="auth-center">
    <div class="auth-card mt-3">
        ...
        <div class="text-center mb-3">
            <img src="{{ asset('robo.png') }}" alt="Alternative" width="44" height="44" class="mb-2">
            <h2 class="fw-bold text-white mb-1" style="font-size: 1.4rem;">Create your account</h2>
            <p class="auth-subtitle">Start chatting with Alternative for free</p>
        </div>
