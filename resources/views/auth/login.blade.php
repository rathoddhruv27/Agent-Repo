    ...
    <div class="auth-form-section">
        ...
        <form action="/login" method="POST" novalidate>
            ...
            <div class="auth-field mb-3">
                ...
                <input type="email" id="email" name="email"value="{{ old('email') }}" placeholder="you@example.com" required autofocus class="{{ $errors->has('email') ? 'is-error' : '' }}">
                @error('email')
            ...
            <button type="submit" class="auth-btn w-100">Sign In</button>
        </form>
